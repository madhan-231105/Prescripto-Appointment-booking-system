...
const updateProfile = async (req, res) => {
  try {
    ...
    const userId = req.user.id; // make sure authUser sets req.user.id
...
const bookAppointment = async (req, res) => {
  try {
    const userId = req.user.id;   // <--- Get userId from logged-in user, NOT req.body
...
const cancelAppointment = async (req, res) => {
  try {
    const userId = req.user.id; // ✅ get from logged-in user
